...
public class ClickGameImages extends AsyncTask<URL, Void, Bitmap>
{
    ...
    public ClickGameImages(Context context, ImageObject inImage, String inFileName, String inItemName)
    {
