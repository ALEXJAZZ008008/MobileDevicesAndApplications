...
public class Image extends AsyncTask<URL, Void, Bitmap>
{
    ...
    public Image(Context context, ImageObject inImage, String inFileName, String inItemName)
    {
