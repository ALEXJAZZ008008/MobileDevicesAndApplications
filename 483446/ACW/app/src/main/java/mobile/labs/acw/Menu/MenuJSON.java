...
public class MenuJSON extends AsyncTask<URL, Void, ArrayList<ArrayList<String>>>
{
    ...
    public MenuJSON(Context context, ArrayList<ArrayList<String>> inJSONArrays, String inKey, String[] inArguments)
    {
