...
public class DragGameActivity extends Activity
{
    ...
    public DragSquareObject moveSquare;
    ...
    private void ResetPreferencesValues()
    {
        ...
        moveSquare = new DragSquareObject(new TwoDimensionalVectorObject(-1, -1), new TwoDimensionalVectorObject(-1, -1));
        currentMatches = 0;
        firstBoolean = false;
    }
    ...
    private void GetPreferences()
    {
        ...
        moveSquare.getSquare().SetX(Preferences.ReadInteger(this, "moveSquareSquareX", moveSquare.getSquare().GetX()));
        moveSquare.getSquare().SetY(Preferences.ReadInteger(this, "moveSquareSquareY", moveSquare.getSquare().GetY()));
        moveSquare.getPosition().SetX(Preferences.ReadInteger(this, "moveSquarePositionX", moveSquare.getPosition().GetX()));
        moveSquare.getPosition().SetY(Preferences.ReadInteger(this, "moveSquarePositionY", moveSquare.getPosition().GetY()));
    ...
    private void SavePreferences()
    {
        ...
        for(Integer i = 0; i < squares.size(); i++)
        {
            for(Integer j = 0; j < squares.get(i).size(); j++)
            {
                ...
                Preferences.WriteInteger(this, "layout" + String.valueOf(i) + String.valueOf(j), squares.get(i).get(j).GetImagePosition());
            }
        }
