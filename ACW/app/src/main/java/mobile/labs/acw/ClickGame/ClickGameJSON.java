...
public class ClickGameJSON extends AsyncTask<URL, Void, ArrayList<ArrayList<String>>>
{
    ...
    public ClickGameJSON(Context context, ArrayList<ArrayList<String>> inJSONArrays, String inKey, String[] inArguments)
    {
